...
import com.example.chickenmasala.interactors.GetAListOfCakeRecipesInteractor
...
class CakeRecipeFragment : BaseFragment<FragmentRecyclerBinding>(),
    ...
    private lateinit var cakeAdapter: RecipeHorizontalAdapter
    ...
    private fun setDateCake() {
        ...
        cakeAdapter = RecipeHorizontalAdapter(list, this)
    }
